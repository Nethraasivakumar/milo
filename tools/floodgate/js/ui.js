...
function updateProjectStatusUI(status) {
  ...
  if (status?.deleteStatus.type === 'deleteAction') {
    document.querySelector('#delete-status').innerHTML = status.deleteStatus.status;
    document.querySelector('#delete-status-msg').innerHTML = status.deleteStatus.message;
    document.querySelector('#delete-status-ts').innerHTML = status.deleteStatus.startTime;
  }
